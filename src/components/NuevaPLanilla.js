     ...
     autoComplete="off">
      <FormControl fullWidth>
            ...
            {listaBarrio.map((element) =>(
                  (
                  <MenuItem key={element.id_barrio} value={element.id_barrio}>
        ...
        <FormControl fullWidth>
            ...
            {listaProblematica.map((element) =>(
                  (
                  <MenuItem key={element.id_lista_problematica} value={element.id_lista_problematica} onClick={getLocation}>
