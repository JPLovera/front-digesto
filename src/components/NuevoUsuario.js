      ...
      onSubmit={handleSubmit}>
          ...
          <FormControl fullWidth>
            ...
            {saveGenero.map((element) =>(
                  (
                  <MenuItem key={element.id_genero} value={element.id_genero}>{element.nombre_genero}</MenuItem>
                )
            ))}
          ...
          <InputLabel>Jerarquia</InputLabel>
            ...
            {saveJerarquia.map((element) =>(
                  (
                  <MenuItem key={element.id_jerarquia} value={element.id_jerarquia}>{element.nombre_jerarquia}</MenuItem>
                )
            ))}
            </Select>
          </FormControl>
          <Toolbar></Toolbar>
          <Button variant="contained" type="submit" sx={{backgroundColor:'#35BC75'}} >
